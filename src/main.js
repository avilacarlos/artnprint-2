...
const templateDigitales = `
  <div class="space-y-6 w-full px-4">
    ...
    <!-- Botones a Demos -->
    <p class="titulo-derecha">ejemplos de nuestras invitaciones</p>
    <div class="flex flex-col gap-4 w-full items-center">
      ...
      <div class="w-full h-auto bg-[#ffffff50] p-4 rounded-2xl border border-[#b34f8320] shadow-inner flex flex-col items-center">
        <p class="textos-btn-digital">Perfecta para Bautizos, Primeras Comuniones y fiestas infantiles.</p>
         <a href="https://sobre-fatima.netlify.app/" target="_blank" class="titulo-btn">Invitación Basica</a>
      </div>

      <!-- Boton estandar -->  
      <div class="w-full h-auto bg-[#ffffff50] p-4 rounded-2xl border border-[#b34f8320] shadow-inner flex flex-col items-center">
        <p class="textos-btn-digital">Ideal para Bodas y XV Años con pocos invitados donde se quiere transmitir calidez y estilo.</p>
         <a href="https://sobre-fatima.netlify.app/" target="_blank" class="titulo-btn">Invitación Estandar</a>
      </div>
      
      <!-- Boton premium -->  
      <div class="w-full h-auto bg-[#ffffff50] p-4 rounded-2xl border border-[#b34f8320] shadow-inner flex flex-col items-center">
        <p class="textos-btn-digital">La experiencia más completa con música, RSVP y galería de fotos.</p>
         <a href="https://pruebaboda.netlify.app/" target="_blank" class="titulo-btn">Invitación Premium</a>
      </div>
    </div>
  </div>      
`;
